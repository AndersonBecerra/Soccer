...
namespace Soccer.Web.Data
{
    public class SeedDb
    {
        ...
        public async Task SeedAsync()
        {
            ...
            await CheckUserAsync("2020", "Juan", "Zuluaga", "andzerotox@hotmail.com", "350 634 2747", "Calle Luna Calle Sol", UserType.User);
            await CheckUserAsync("3030", "Anderson", "Becerra", "andersonfpsi@gmail.com", "350 634 2747", "Calle Luna Calle Sol", UserType.User);
            await CheckUserAsync("4040", "Anderson", "Becerra", "andzerotox@gmail.com", "350 634 2747", "Calle Luna Calle Sol", UserType.User);
        ...
        private async Task CheckTeamsAsync()
        {
            if (!_context.Teams.Any())
            {
                ...
                AddTeam("Nacional");
                AddTeam("Napoles");
                AddTeam("Olympique Lyonnais");
                AddTeam("Olympique Marcella");
                AddTeam("Once Caldas");
                AddTeam("Panama");
                AddTeam("Paraguay");
                AddTeam("Peru");
